    ...
    <label style={{ display: "flex", alignItems: "flex-start", gap: 10, cursor: "pointer", marginBottom: 20 }}>
      <div
        ...
        style={{
          ...
          border: `1.5px solid ${checked ? "#000" : "#d0d0d0"}`,
          borderRadius: 5, marginTop: 1,
      ...
      <span style={{ fontSize: 12.5, color: "#666", fontFamily: "'DM Sans', sans-serif", lineHeight: 1.5 }}>
        {label}
      </span>
    </label>
  );
  ...
  return (
    <>
      ...
      <div style={{ minHeight: "100vh", background: "#fff", display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden" }}>
        ...
        {/* Card */}
        <div style={{
          background: "#fff", borderRadius: 22, padding: "44px 40px", width: 420,
          ...
          <Checkbox
            ...
            label={
              <>
                I agree to the{" "}
                <span style={{ color: "#000", fontWeight: 700, textDecoration: "underline", textUnderlineOffset: 3, cursor: "pointer" }}>Terms of Service</span>
                {" "}and{" "}
                <span style={{ color: "#000", fontWeight: 700, textDecoration: "underline", textUnderlineOffset: 3, cursor: "pointer" }}>Privacy Policy</span>
              </>
            }
          />
          ...
          <p style={{ textAlign: "center", margin: "22px 0 0", fontSize: 13, color: "#999", fontFamily: "'DM Sans', sans-serif" }}>
            ...
            <Link href="/login" style={{ color: "#000", fontWeight: 700, textDecoration: "underline", textUnderlineOffset: 3 }}>
              Sign in
            </Link>
          </p>
        </div>
