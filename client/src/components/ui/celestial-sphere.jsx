...
export const CelestialSphere = ({
    ...
    useEffect(() => {
        ...
        // --- Shaders with your color scheme ---
        const vertexShader = `
            varying vec2 vUv;
            void main() {
                vUv = uv;
        ...
        const fragmentShader = `
            ...
            void main() {
                ...
                // Final color calculation - using your brand colors
                float nebula = pow(t, 2.0);
                
                // Create gradient from your brand colors (#0f2027, #203a43, #2c5364)
                vec3 color1 = vec3(0.059, 0.125, 0.153); // #0f2027
                vec3 color2 = vec3(0.125, 0.227, 0.263); // #203a43
                vec3 color3 = vec3(0.172, 0.325, 0.392); // #2c5364
                
                vec3 color = mix(color1, color2, nebula);
                color = mix(color, color3, nebula * 1.5);
                
                // Add glowing effect
                color += vec3(0.2, 0.25, 0.3) * nebula;
