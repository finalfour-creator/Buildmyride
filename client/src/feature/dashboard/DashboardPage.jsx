...
//   // Get user from localStorage if session not available
//   const userName = session?.user?.name || (typeof window !== "undefined" ? JSON.parse(localStorage.getItem("user")?.name || "null" || "{}") : null)?.name || "User");

//   // ✅ LOADING STATE HANDLING (after hooks only)
//   if (status === "loading") {
